        ...
        <form id="generator-form" enctype="multipart/form-data" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select id="offer" name="offer" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></select>
                </div>
                <div>
                    <label for="shared_domain" class="block text-sm font-medium text-gray-700">Domain Bersama</label>
                    <select id="shared_domain" name="shared_domain" required class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></select>
                </div>
                <div>
                    <label for="redirect_type" class="block text-sm font-medium text-gray-700">Tipe Pengalihan</label>
                    <select id="redirect_type" name="redirect_type" required class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></select>
                </div>
                <div>
                    <label for="type" class="block text-sm font-medium text-gray-700">Tipe Link</label>
                    <select id="type" name="type" required class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></select>
                </div>
                <div>
                    <label for="generation_mode" class="block text-sm font-medium text-gray-700">Mode Pembuatan</label>
                    <select id="generation_mode" name="generation_mode" required class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></select>
                </div>
                <div id="shortener-choice-container" class="hidden">
                    ...
                    <select id="shortener_choice" name="shortener_choice" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></select>
                </div>
            </div>
            ...
            <div class="p-6 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="meta_title" name="meta_title" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm">
                    </div>
                    <div>
                        <label for="meta_description" class="block text-sm font-medium text-gray-700">Meta Description</label>
                        <textarea id="meta_description" name="meta_description" rows="3" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm"></textarea>
                    </div>
                    <div>
